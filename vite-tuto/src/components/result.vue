...
export default {
	/* declare props in the props options */
	props: {
		query: String
	},
	/* props: object that contains component's props */
	/* context: object that contains specific properties found on `this` */
	/* setup(): executed before creating the component object */
	setup (props, context) {
